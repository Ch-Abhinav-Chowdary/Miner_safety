...
const UserManagement = () => {
  ...
  // Load real users (workers + supervisors) from backend
  useEffect(() => {
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-blue-100">
              Assign daily working locations/positions for workers and supervisors.
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="relative w-full md:w-1/3">
            <input
              type="text"
              placeholder="Search workers or supervisors by name or email..."
              value={searchTerm}
      ...
      {loading ? (
        ...
        >
          ...
          <p className="text-gray-500 text-sm mt-1">
            Make sure there are registered workers or supervisors.
          </p>
        </motion.div>
      ) : (
        <motion.div
