...
const Sidebar = ({ userRole, isOpen, onClose }) => {
  ...
  const navItems = [
    ...
    { to: '/daily-checklist', labelKey: 'nav.safetyChecklist', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4', roles: ['worker', 'supervisor', 'admin', 'dgms_officer'] },
    ...
    { to: '/admin/audit-logs', labelKey: 'nav.auditLogs', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10', roles: ['admin'] },
  ];
