    ...
    newSocket.on('sos-emergency-alert', (alertData) => {
      ...
      if ('Notification' in window && Notification.permission === 'granted') {
        new Notification(`🚨 Emergency SOS Alert: ${alertData.hazardLabel}`, {
          body: `Triggered by ${alertData.workerName} at ${alertData.location?.description || 'Unknown location'}`,
          icon: '/vite.svg',
          badge: '/vite.svg',
          tag: alertData.id,
      ...
      try {
        ...
        if (response.data.success) {
          setAlerts(response.data.data.map(alert => ({
            ...
            workerId: alert.triggeredBy._id,
            workerName: alert.triggeredBy.name,
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm space-y-1">
                    ...
                    <p>
                      <strong>ID:</strong> {alert.workerId}
                    </p>
                    <p>
